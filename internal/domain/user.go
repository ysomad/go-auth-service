...
type User struct {
	...
	Email             string    `json:"email"      example:"email@gmail.com"     validate:"required,email"`
	Password          string    `json:"password"   example:"secret"              validate:"required"`
	EncryptedPassword string    `json:"-"`
	FirstName         string    `json:"first_name" example:"Alex"`
	LastName          string    `json:"last_name"  example:"Malone"`
	CreatedAt         time.Time `json:"created_at" example:"2009-11-10 23:00:00" validate:"required"`
}
